...
- **Output Folder**: {project-root}/_bmad
- **Planning Artifacts**: {project-root}/_bmad/planning-artifacts
- **Implementation Artifacts**: {project-root}/_bmad/implementation-artifacts
